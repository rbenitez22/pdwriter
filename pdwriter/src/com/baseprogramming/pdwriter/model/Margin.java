...
public class Margin
{
    ...
    public Margin(PdUnit top, PdUnit right, PdUnit bottom, PdUnit left)
    {
        this.top = top;
        this.right = right;
        this.bottom = bottom;
    ...
    public Margin(float topInInches, float rightInInches, float bottomInInches, float leftInInches)
    {
