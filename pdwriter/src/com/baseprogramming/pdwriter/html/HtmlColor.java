...
public enum HtmlColor
{
    ...
    public static Color getColor(String colorHexString)
    {
        if(colorHexString==null || colorHexString.isEmpty())
        {
            throw new IllegalArgumentException("Null Or empty color Hex String argument");
        }
        String string=colorHexString;
        if(string.startsWith("#")){string=string.substring(1);}
        string=String.format("%-6s", string).replace(" ", "0");
        
        int rgb=Integer.parseInt(string, 16);
